...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionVote.cm_name'
        db.add_column('phillyleg_actionvote', 'cm_name',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


        # Changing field 'ActionVote.councilmember'
        db.alter_column('phillyleg_actionvote', 'councilmember_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['phillyleg.CouncilMember'], null=True))
    def backwards(self, orm):
        # Deleting field 'ActionVote.cm_name'
        db.delete_column('phillyleg_actionvote', 'cm_name')


        # Changing field 'ActionVote.councilmember'
        db.alter_column('phillyleg_actionvote', 'councilmember_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['phillyleg.CouncilMember']))
    models = {
        'phillyleg.actionvote': {
            'Meta': {'object_name': 'ActionVote'},

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ActionVote', fields ['cm_name', 'legaction']
        db.delete_unique('phillyleg_actionvote', ['cm_name', 'legaction_id'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'ActionVote', fields ['cm_name', 'legaction']
        db.create_unique('phillyleg_actionvote', ['cm_name', 'legaction_id'])

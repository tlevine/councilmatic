...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActionVote'
        db.create_table('phillyleg_actionvote', (
            ...
            ('vote', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('councilmember', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['phillyleg.CouncilMember'])),
            ('legaction', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['phillyleg.LegAction'])),
        ))
        db.send_create_signal('phillyleg', ['ActionVote'])

        # Adding field 'LegFile.name'
        db.add_column('phillyleg_legfile', 'name',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'ActionVote'
        db.delete_table('phillyleg_actionvote')

        # Deleting field 'LegFile.name'
        db.delete_column('phillyleg_legfile', 'name')
